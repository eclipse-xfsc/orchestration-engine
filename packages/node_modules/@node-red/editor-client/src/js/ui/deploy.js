...
RED.deploy = (function() {
    ...
    function init(options) {
        ...
        if (type == "default") {
            $('<li><span class="red-ui-deploy-button-group button-group disabled">'+
        ...
        RED.events.on('workspace:dirty',function(state) {
            ...
            if (state.dirty) {
                ...
                //label
                $(".red-ui-deploy-button-group").removeClass("disabled");
            } else {
                // window.onbeforeunload = null;
                $("#red-ui-header-button-deploy").addClass("disabled");
                //label
                $(".red-ui-deploy-button-group").addClass("disabled");
            }
        });
