...
function createNode(node,def) {
    ...
    function handleMessage(msg) {
        // var Id = data.id;
        // countMessage(Id);
        comms.publish("/sendMessage", data);
    }
    
    // function countMessage(Id) {
    //     if (Id in nodeMessageCount) {
    //         nodeMessageCount[Id]++;
    //     } else {
    //     nodeMessageCount[Id] = 1;
    //     }
    //     data.messageCount = nodeMessageCount[Id];
    // }
    //
