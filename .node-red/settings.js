...
const dataDir = path.join(homeDir, '.node-red');
 ...
 ******************************************************************************/
    ...
    //     type: "credentials",
    //     users: [{
    //         username: "admin",         // your chosen username
    //         password: "<YOUR_HASH_HERE>",  // the bcrypt hash from step 1
    //         permissions: "*"           // or "read" / "write" as you wish
    //     }]
    // },
    ...
    editorTheme: {
        ...
        page: {
            ...
            scripts: [
                path.join(dataDir, 'guided-script.js')
            ]
        },
